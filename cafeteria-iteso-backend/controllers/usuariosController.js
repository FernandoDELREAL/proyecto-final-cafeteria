...
const eliminarTarjeta = (req, res) => {
  ...
  const sql = "UPDATE usuarios SET banco = NULL, numero_tarjeta = NULL WHERE email = ?";
...
module.exports = { obtenerUsuarios, loginUsuario,crearUsuario, actualizarTarjeta, eliminarTarjeta};
